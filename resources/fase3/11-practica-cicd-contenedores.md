...
flowchart TD
  ...
  B["<b>Source Control</b><br/>(GitHub)"]
  C["<b>Continuous Integration</b><br/>• Build & Test<br/>• Security Scan<br/>• Image Build & Push"]
  D["<b>Container Registry</b><br/>(Docker Hub / Harbor / ECR)"]
  E["<b>Continuous Deployment</b><br/>Dev → Staging → Production<br/>(Blue/Green + Canary)"]
  F["<b>Monitoring & Observability</b><br/>Metrics • Logs • Alerts • Automatic Rollback"]
